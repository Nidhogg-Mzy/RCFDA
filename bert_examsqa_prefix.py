...
def main():
    ...
    #args.output_dir = "F:\\aca\\23fall\\COMP5212\\Project\\exams-qa\\train\\"
    options_print = ""
    ...
    adapters.init(model)
    config1 = PrefixTuningConfig(flat=False, prefix_length=30)
    model.add_adapter(adapter_name="prefix_tuning", config=config1)
